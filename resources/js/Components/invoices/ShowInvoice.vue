...
onMounted(async () => {
    await storeInvoice.show_invoice(route.params.id);
    // console.log(storeInvoice.getInvoice);
    form.value = storeInvoice.getInvoice;
...
const onEdit = (id) => {
    router.push({name: "EditInvoice", params:{ id: id} })
}
</script>
